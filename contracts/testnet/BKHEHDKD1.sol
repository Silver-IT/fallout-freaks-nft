...
contract BKHEHDKD1 is Ownable, ReentrancyGuard {
    ...
    constructor() {
        user1 = 0xFA60C3295Ea671E365B9A242551Cf1Ff314Bf045;
        user2 = 0x8e5F332a0662C8c06BDD1Eed105Ba1C4800d4c2f;
        user3 = 0x954BfE5137c8D2816cE018EFd406757f9a060e5f;
        ...
        )
    {
        ...
        user2Amount = (balance * 4000) / 10000; // 40.00%
        rest -= user2Amount;
